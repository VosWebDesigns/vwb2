    ...
    <div className="space-y-6 max-w-5xl mx-auto pb-20">
      ...
      <div className="flex flex-col sm:flex-row justify-between gap-4">
        ...
        <Button
          onClick={handleSave}
          disabled={saving}
          className="bg-[var(--accent)] text-black min-w-[140px]"
        >
          {saving ? (
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="bg-[rgba(8,8,18,.82)] border border-[rgba(201,169,110,.09)] w-full justify-start h-auto flex-wrap p-2 gap-2 mb-6 rounded-lg">
          <TabsTrigger 
            value="general"
            className="data-[state=active]:bg-[var(--accent)] data-[state=active]:text-black text-gray-400"
          >
        ...
        <div className="space-y-4">
          ...
          <TabsContent value="general">
            <Card className="bg-[rgba(8,8,18,.82)] border-[rgba(201,169,110,.09)]">
              <CardHeader>
              ...
              <CardContent className="space-y-4">
                <div className="grid gap-2">
                  ...
                  <Input 
                    ...
                    className="bg-black border-[rgba(201,169,110,.16)] text-white focus:border-[var(--accent)]" 
                  />
                </div>
                <div className="grid gap-2">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="grid gap-2">
                    ...
                    <Input id="website" name="website" value={formData.website || ''} onChange={handleInputChange} className="bg-black border-[rgba(201,169,110,.16)] text-white focus:border-[var(--accent)]" />
                  </div>
                  <div className="grid gap-2">
                    <Label htmlFor="logo_url" className="text-gray-300">Logo URL</Label>
                    <Input id="logo_url" name="logo_url" value={formData.logo_url || ''} onChange={handleInputChange} placeholder="/logo.jpeg" className="bg-black border-[rgba(201,169,110,.16)] text-white focus:border-[var(--accent)]" />
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="grid gap-2">
                    ...
                    <Input id="kvk" name="kvk" value={formData.kvk || ''} onChange={handleInputChange} className="bg-black border-[rgba(201,169,110,.16)] text-white focus:border-[var(--accent)]" />
                  </div>
                  <div className="grid gap-2">
                    <Label htmlFor="iban" className="text-gray-300">IBAN</Label>
                    <Input id="iban" name="iban" value={formData.iban || ''} onChange={handleInputChange} className="bg-black border-[rgba(201,169,110,.16)] text-white focus:border-[var(--accent)]" />
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-[rgba(8,8,18,.82)] border-[rgba(201,169,110,.09)]">
              ...
              <CardContent className="space-y-4">
                <div className="grid gap-2">
                  ...
                  <Input id="seo_title" name="seo_title" value={formData.seo_title || ''} onChange={handleInputChange} className="bg-black border-[rgba(201,169,110,.16)] text-white focus:border-[var(--accent)]" />
                </div>
                <div className="grid gap-2">
                ...
                <div className="grid gap-4 sm:grid-cols-3">
                  <div className="grid gap-2">
                    ...
                    <Input id="default_payment_term_days" name="default_payment_term_days" type="number" value={formData.default_payment_term_days || 14} onChange={handleInputChange} className="bg-black border-[rgba(201,169,110,.16)] text-white focus:border-[var(--accent)]" />
                  </div>
                  <div className="grid gap-2">
                    <Label htmlFor="default_vat_rate" className="text-gray-300">Standaard btw %</Label>
                    <Input id="default_vat_rate" name="default_vat_rate" type="number" value={formData.default_vat_rate || 21} onChange={handleInputChange} className="bg-black border-[rgba(201,169,110,.16)] text-white focus:border-[var(--accent)]" />
                  </div>
                  <div className="grid gap-2">
                    <Label htmlFor="default_quote_validity_days" className="text-gray-300">Offerte geldigheid</Label>
                    <Input id="default_quote_validity_days" name="default_quote_validity_days" type="number" value={formData.default_quote_validity_days || 14} onChange={handleInputChange} className="bg-black border-[rgba(201,169,110,.16)] text-white focus:border-[var(--accent)]" />
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <TabsContent value="notifications">
            <Card className="bg-[rgba(8,8,18,.82)] border-[rgba(201,169,110,.09)]">
              ...
              <CardContent className="space-y-6">
                <div className="flex items-center justify-between space-x-2 border-b border-[rgba(201,169,110,.09)] pb-4">
