...
export const StaticBackdrop = () => (
  <div className="pointer-events-none fixed inset-0 z-0" aria-hidden="true">
    <div
      ...
      style={{
        background:
          'radial-gradient(ellipse 70% 50% at 50% -5%, rgba(204,255,0,.08), transparent 60%),' +
          'radial-gradient(ellipse 50% 50% at 85% 80%, rgba(255,63,0,.05), transparent 60%),' +
          'radial-gradient(ellipse 60% 60% at 10% 50%, rgba(20,30,10,.18), transparent 60%)',
      }}
    />
